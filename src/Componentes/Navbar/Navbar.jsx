...
const Navbar = () => {
  ...
  return (
    <nav data-aos="fade-right" className="flex flex-col  bg-black md:flex-row  md:justify-between   items-center px-8 py-4 text-white shadow-lg gap-4">
  ...
  <NavLink to="/" className="flex items-center gap-2">
      ...
      <ul data-aos="fade-left" className="flex flex-col font-semibold text-3xl text-amber-200 md:flex-row items-center gap-4  md:text-sm ">
